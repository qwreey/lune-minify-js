...
use minify_js::{TopLevelMode, Session};
...
#[no_mangle]
pub unsafe extern "C" fn minify(session: *mut ManuallyDrop<Session>, len: i32, ptr: *mut u8, toplevel: *mut TopLevelMode) -> MinifyResult {
  let mut out = Vec::new();
